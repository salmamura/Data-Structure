#ifndef LISTOFMAHASISWA_H_INCLUDED
#define LISTOFMAHASISWA_H_INCLUDED
...
address alokasi(int nimX, char* namaX, int transportX, int makanX, int biayaKostX, int totalBiayaX);
...
address searchMhs(ListOfMhs LM, int nimX);
...
#endif // LISTOFMAHASISWA_H_INCLUDED
